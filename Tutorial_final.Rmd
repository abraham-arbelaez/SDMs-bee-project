...
df1.bba <- read.csv("C:/Users/dyhol/OneDrive - Kansas State University/BBSDM/BBSDM_KS_2022/BBW_KansasRecords_5April2024_Holthaus_KState.csv")
...
precip <- raster("C:/Users/dyhol/OneDrive - Kansas State University/BBSDM/BBSDM_KS_2022/prism/PRISM_ppt_stable_4kmM3_2022_bil.bil")
tmax <- raster("C:/Users/dyhol/OneDrive - Kansas State University/BBSDM/BBSDM_KS_2022/prism/PRISM_tmax_stable_4kmM3_2022_bil.bil")
tmin <- raster("C:/Users/dyhol/OneDrive - Kansas State University/BBSDM/BBSDM_KS_2022/prism/PRISM_tmin_stable_4kmM3_2022_bil.bil")
tmean <- raster("C:/Users/dyhol/OneDrive - Kansas State University/BBSDM/BBSDM_KS_2022/prism/PRISM_tmean_stable_4kmM3_2022_bil.bil")
...
summary(ipp.bgris) #sig = grass(-), wet, wood(-), ag(-), precip, tmax(-), tmin(-), tmean
...
# Backward elimination: 
f3.bfrat <- update(f2.bfrat, ~ . + s(X,Y, bs = "gp", k = 200) - dev.perc)
...
# Backward elimination: 
f4.bfrat <- update(f3.bfrat, ~ . + s(X,Y, bs = "gp", k = 200) - precip) 
...
# Backward elimination: 
f5.bfrat <- update(f4.bfrat, ~ . + s(X,Y, bs = "gp", k = 200) - tmin) 
...
# Backward elimination: 
f6.bfrat <- update(f5.bfrat, ~ . + s(X,Y, bs = "gp", k = 200) - tmax) 
...
# Backward elimination: 
f7.bfrat <- update(f6.bfrat, ~ . + s(X,Y, bs = "gp", k = 200) - tmean) 

ipp.bfrat <- gam(f7.bfrat, data = df.bfrat.ipp, family = poisson,
           weights = wt, method = "REML")

summary(ipp.bfrat) #sig = grass(-), wet, wood(-), ag(-)
...
# Backward elimination: 
f3.BGRIS <- update(f2.BGRIS, ~ . + s(X,Y, bs = "gp", k = 200) - tmean) 
...
# Backward elimination: 
f4.BGRIS <- update(f3.BGRIS, ~ . + s(X,Y, bs = "gp", k = 200) - tmax)
...
# Backward elimination: 
f5.BGRIS <- update(f4.BGRIS, ~ . + s(X,Y, bs = "gp", k = 200) - dev.perc) 
...
# Backward elimination: 
f6.BGRIS <- update(f5.BGRIS, ~ . + s(X,Y, bs = "gp", k = 200) - wood.perc) 
...
# Backward elimination: 
f7.BGRIS <- update(f6.BGRIS, ~ . + s(X,Y, bs = "gp", k = 200) - grass.perc) 
...
# Backward elimination: 
f8.BGRIS <- update(f7.BGRIS, ~ . + s(X,Y, bs = "gp", k = 200) - tmin) 

ipp.BGRIS <- gam(f8.BGRIS, data = df.BGRIS.ipp, family = poisson,
           weights = wt, method = "REML")

summary(ipp.BGRIS) #sig = wet, ag(-), precip
...
# Backward elimination: 
f5.BFRAT <- update(f4.BFRAT, ~ . + s(X,Y, bs = "gp", k = 200) - tmax) 
...
# Backward elimination: 
f7.BFRAT <- update(f6.BFRAT, ~ . + s(X,Y, bs = "gp", k = 200) - precip) 
...
# Backward elimination: 
f8.BFRAT <- update(f7.BFRAT, ~ . + s(X,Y, bs = "gp", k = 200) - grass.perc) 
...
# Backward elimination: 
f9.BFRAT <- update(f8.BFRAT, ~ . + s(X,Y, bs = "gp", k = 200) - tmean) 

ipp.BFRAT <- gam(f9.BFRAT, data = df.BFRAT.ipp, family = poisson,
           weights = wt, method = "REML")

summary(ipp.BFRAT) #sig = wet, ag(-)
...
rl.E.y.3k <- raster(,nrow=55,ncols=55,ext=extent(sf.kansas),crs=crs(sf.kansas))
...
colnames(df.pred.bimp.3k) <- c("X","Y","dev.perc", "wood.perc", "ag.perc", "tmean")


rl.E.y.bimp.3k <- rl.E.y.3k
rl.E.y.bimp.3k[] <- exp(c(predict(ipp,newdata=df.pred.bimp.3k,type="link")))
...
colnames(df.pred.bpen.3k) <- c("X","Y","dev.perc", "wet.perc", "wood.perc", "tmean")
...
colnames(df.pred.BIMP.3k) <- c("X","Y","dev.perc", "wood.perc", "tmax")
...
colnames(df.pred.bgris.3k) <- c("X","Y","grass.perc", "wet.perc","wood.perc","ag.perc", "precip", "tmax", "tmin", "tmean")
...
df.pred.bfrat.3k$wet.perc <- df.pred.all3k$wet.perc
df.pred.bfrat.3k$wood.perc <- df.pred.all3k$wood.perc
df.pred.bfrat.3k$ag.perc <- df.pred.all3k$ag.perc


df.pred.bfrat.3k$grass.perc <- df.pred.bfrat.3k$grass.perc*.01 
df.pred.bfrat.3k$wet.perc <- df.pred.bfrat.3k$wet.perc*.01 
df.pred.bfrat.3k$wood.perc <- df.pred.bfrat.3k$wood.perc*.01 
df.pred.bfrat.3k$ag.perc <- df.pred.bfrat.3k$ag.perc*.01 


colnames(df.pred.bfrat.3k) <- c("X","Y","grass.perc", "wet.perc","wood.perc","ag.perc")
...
colnames(df.pred.BGRIS.3k) <- c("X","Y","wet.perc","ag.perc", "precip")
...
colnames(df.pred.BFRAT.3k) <- c("X","Y","wet.perc","ag.perc")
